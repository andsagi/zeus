...
import { Globe, User, Palette, Shield, Info, Camera, FileText, Lock, ChevronRight, Zap } from 'lucide-react';
import { useUser } from '../lib/UserContext';
import { motion } from 'motion/react';

export const SettingsView = () => {
  const { userData, updateUserData } = useUser();
  const [activeTab, setActiveTab] = useState<'profile' | 'appearance' | 'legal'>('profile');
